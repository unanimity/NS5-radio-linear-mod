...
SHORT ff_cre_syncobj (	/* TRUE:Function succeeded, FALSE:Could not create due to any error */
...
SHORT ff_del_syncobj (	/* TRUE:Function succeeded, FALSE:Could not delete due to any error */
...
SHORT ff_req_grant (	/* TRUE:Got a grant to access the volume, FALSE:Could not get a grant */
