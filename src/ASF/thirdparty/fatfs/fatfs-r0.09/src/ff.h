...
/* Sync functions */
#if _FS_REENTRANT
SHORT	ff_cre_syncobj (BYTE vol, SemaphoreHandle_t* sobj);	/* Create a sync object */
SHORT	ff_req_grant (SemaphoreHandle_t sobj);					/* Lock sync object */
void	ff_rel_grant (SemaphoreHandle_t sobj);					/* Unlock sync object */
SHORT	ff_del_syncobj (SemaphoreHandle_t sobj);				/* Delete a sync object */
#endif
